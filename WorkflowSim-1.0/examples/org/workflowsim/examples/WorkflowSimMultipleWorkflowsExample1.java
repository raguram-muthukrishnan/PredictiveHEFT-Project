...
public class WorkflowSimMultipleWorkflowsExample1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            daxPaths.add("WorkflowSim-1.0/config/dax/Montage_100.xml");
            daxPaths.add("WorkflowSim-1.0/config/dax/Montage_25.xml");
            daxPaths.add("WorkflowSim-1.0/config/dax/Montage_1000.xml");
            /**
